...
const IeltsSpeakingPractice = () => {
    ...
    return (
    <main className="relative min-h-screen h-screen flex flex-col bg-gradient-to-b from-[#F5F7FA] to-white">
      {/* Overlay loading */}
      {loading && (
        ...
        <div className="flex flex-col md:flex-row flex-1">
          ...
          <div className="flex flex-col w-full md:w-3/5 gap-5 h-full overflow-y-auto">
            <RecordingPractice
              ...
              onScore={(data) => setScoreData(data)} // callback khi có kết quả
  setLoading={setLoading} // 👈 truyền xuống
            />
          </div>
            ...
            />
                ...
                {scoreData && !loading && (
                    <>
                        ...
                        {scoreData.incorrectPhonemes &&
                            scoreData.incorrectPhonemes.length > 0 && (
